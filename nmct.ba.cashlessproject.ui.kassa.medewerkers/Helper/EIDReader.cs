...
namespace nmct.ba.cashlessproject.ui.kassa.Helper
{
        ...
        public static EID LaadEID()
        {
            ...
            try
            {
                ...
                if (Reader.isCardPresent())
                {
                    ...
                    {
                        eidReader.Error = "Kaart kan niet worden gebruikt";
                    }
                }
                else
                {
                    eidReader.Error = "Kaartlezer niet aangesloten";
                }
                ...
                if (eid != null)
                {
                    ...
                    if (typeof(Employee) == type)
                    {
                        return new Employee()
                        {
                            ...
                            Picture = eid.Image,
                            RegisterNumber = eid.RegisterNumber,
                            Email = eid.FirstName + "." + eid.LastName + "@hotmail.com",
                            Phone = "050"
                        };
                    }
