...
namespace nmct.ba.cashlessproject.web.Helper
{
    ...
    public class Database
    {
        ...
        public static ConnectionStringSettings GetConnectionStringSetting(string ConnectionString)
        {
            ConnectionStringSettings settings = ConfigurationManager.ConnectionStrings[ConnectionString];
            return settings;
        }
        ...
        public static DbParameter AddParameter(ConnectionStringSettings setting, string name, object value)
        {
            DbParameter par = DbProviderFactories.GetFactory(setting.ProviderName).CreateParameter();
            par.ParameterName = name;
            par.Value = value;
